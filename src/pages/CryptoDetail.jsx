...
export default function CryptoDetail() {
  ...
  const liveCurrency = usePrices()?.prices?.find(c => c.id === id)
  
  // Return skeleton if required data is missing
  if (!crypto || !history || !crypto.id || !history.prices) {
    return <CurrencyDetailSkeleton />
  }
  
  // Use the live 24h price change if available; fall back to market_data
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">
          {crypto.name} {useTranslation().t('common.price')}
        </h1>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded">
            <p className="text-gray-500 dark:text-gray-400">{useTranslation().t('common.price')}</p>
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded">
            <p className="text-gray-500 dark:text-gray-400">{useTranslation().t('common.change24h')}</p>
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded">
            <p className="text-gray-500 dark:text-gray-400">{useTranslation().t('common.marketCap')}</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded">
            <p className="text-gray-500 dark:text-gray-400">{useTranslation().t('common.volume')}</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">
          {useTranslation().t('common.priceHistory')}
        </h2>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">
          {useTranslation().t('common.additionalInfo')}
        </h2>
